...
function addResponseToDB(res,transactionID,username,session){
    ...
    res.on('data', async function (chunk) {
        ...
        try{
            const rows = await pool.query(query,[transactionID,username,session,chunk,res.statusCode]);
...
exports.sendRequest = async function(resBuilder,serverConfig,path,{body, headers, query},method){
